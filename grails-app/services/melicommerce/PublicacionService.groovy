...
class PublicacionService {
	...
	def crearPublicacion(String titulo, String desc, double precio, boolean esNuevo, Long id) {
		...
		Publicacion pub = new Publicacion(titulo: titulo, fechaPublicacion: mydate, descripcion: desc, precio: precio, fueVendido : false, esPublicacionSinUso: esNuevo, userId: id)
		if(precio > 0) {
			pub.save()		
		}
		return pub
